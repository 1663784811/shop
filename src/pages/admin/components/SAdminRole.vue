...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sAdminRole";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSAdminRole,
        API_addSAdminRole,
        API_updateSAdminRole,
        API_findIdSAdminRole,
        API_delSAdminRole
    } from "@/config/api/sAdminRole";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSAdminRole(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSAdminRole(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSAdminRole(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSAdminRole(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSAdminRole(sendObj).then(responseData => {
