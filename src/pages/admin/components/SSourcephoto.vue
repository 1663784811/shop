...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sSourcephoto";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSSourcephoto,
        API_addSSourcephoto,
        API_updateSSourcephoto,
        API_findIdSSourcephoto,
        API_delSSourcephoto
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSSourcephoto(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSSourcephoto(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSSourcephoto(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSSourcephoto(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSSourcephoto(sendObj).then(responseData => {
