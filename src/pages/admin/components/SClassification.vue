...
<script>
    ...
    export default {
        name: "TableTree_SClassification",
        components: {
            BaseOperation,
            BaseWindow
        },
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findPageSClassification(this.requestTableData).then(res => {
            ...
            submitDataFn: function () {
                ...
                API_saveSClassification(this.submitData).then(() => {
                    this.winShow = false;
            ...
            delIdFn: function (sendObj) {
                API_delSClassification(sendObj).then(responseData => {
