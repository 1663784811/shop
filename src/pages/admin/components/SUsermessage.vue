...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sUsermessage";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSUsermessage,
        API_addSUsermessage,
        API_updateSUsermessage,
        API_findIdSUsermessage,
        API_delSUsermessage
    } from "@/config/api/sUsermessage";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSUsermessage(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSUsermessage(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSUsermessage(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSUsermessage(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSUsermessage(sendObj).then(responseData => {
