...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sMessagephoto";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSMessagephoto,
        API_addSMessagephoto,
        API_updateSMessagephoto,
        API_findIdSMessagephoto,
        API_delSMessagephoto
    } from "@/config/api/sMessagephoto";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSMessagephoto(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSMessagephoto(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSMessagephoto(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSMessagephoto(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSMessagephoto(sendObj).then(responseData => {
