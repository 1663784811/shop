...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sOrderproduct";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSOrderproduct,
        API_addSOrderproduct,
        API_updateSOrderproduct,
        API_findIdSOrderproduct,
        API_delSOrderproduct
    } from "@/config/api/sOrderproduct";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSOrderproduct(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSOrderproduct(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSOrderproduct(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSOrderproduct(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSOrderproduct(sendObj).then(responseData => {
