...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sProdutphoto";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSProdutphoto,
        API_addSProdutphoto,
        API_updateSProdutphoto,
        API_findIdSProdutphoto,
        API_delSProdutphoto
    } from "@/config/api/sProdutphoto";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSProdutphoto(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSProdutphoto(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSProdutphoto(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSProdutphoto(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_delSProdutphoto(sendObj).then(responseData => {
