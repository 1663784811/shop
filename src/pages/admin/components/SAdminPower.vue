...
<script>
    ...
    import {
        ...
        TableHeaderJson,
        searchWhereJson
    } from "@/jsonObj/sAdminPower";

    import '@/assets/admin/css/adminPage.css';
    import {
        API_findAllSAdminPower,
        API_addSAdminPower,
        API_updateSAdminPower,
        API_findIdSAdminPower,
        API_delSAdminPower
    } from "@/config/api/sAdminPower";
    import {
        CREATETREESTRUCTURE,
        TREE2ARRAY
    ...
    export default {
        ...
        methods: {
            ...
            requestTableDataFn: function () {
                ...
                API_findAllSAdminPower(this.requestTableData).then(responseData => {
                    let treeData = [];
            ...
            addSubmitDataFn: function () {
                ...
                API_addSAdminPower(this.submitData).then(() => {
            ...
            updateSubmitDataFn: function (successCallBack, errorCallBack) {
                ...
                API_updateSAdminPower(this.submitData).then(() => {
            ...
            findIdFn: function (sendObj, successCallBack, errorCallBack) {
                API_findIdSAdminPower(sendObj).then(responseData => {
            ...
            delIdFn: function (sendObj) {
                API_delSAdminPower(sendObj).then(responseData => {
